<h1>WPSSO Schema JSON-LD Markup</h1>

<table>
<tr><th align="right" valign="top" nowrap>Plugin Name</th><td>WPSSO Schema JSON-LD Markup</td></tr>
<tr><th align="right" valign="top" nowrap>Summary</th><td>WPSSO Core add-on offers Schema JSON-LD / Google SEO Rich Results for Articles, Events, Local Business, Products, Recipes, Reviews and many more.</td></tr>
...
<tr><th align="right" valign="top" nowrap>Tags / Keywords</th><td>schema.org, rich results, structured data, knowledge graph, rich pins, rich cards, woocommerce, pinterest, local seo, image seo, video seo, news seo, rating, review, recipe, event, product, qapage, howto</td></tr>
</table>
...
<li>A value for the <em>logo</em> field is required.</li>
<li>A value for the <em>publisher</em> field is required.</li>
<li>The <em>aggregateRating</em> field is recommended.</li>
<li>The <em>brand</em> field is recommended.</li>
<li>The <em>headline</em> field is recommended.</li>
<li>The <em>image</em> field is recommended.</li>
<li>The <em>mainEntityOfPage</em> field is recommended.</li>
<li>The <em>review</em> field is recommended.</li>
...
<p>&#x2605;&#x2605;&#x2605;&#x2605;&#x2605; &mdash; "Forget everything else this is the best schema plugin - Sincerely, we bought other plugins that we had to abandon due to the lack of important features, but with this [WPSSO JSON] we get all that we need - and our schema has more features than the competition!" - <a href="https://wordpress.org/support/topic/forget-everything-else-this-is-the-best-schema-plugin/">zuki305</a></p>
...
<li><p>Provides Schema JSON-LD markup (aka Structured Data) for the following Schema types (other Schema types are available in the Premium add-on):</p>
...
<li>Add 5 Star Rating If No Rating</li>
</ul></li>
<li>Schema Types
...
<li><a href="https://schema.org/ClaimReview">schema.org/ClaimReview</a></li>
...
<li><a href="https://schema.org/ItemList">schema.org/ItemList</a> (includes 3 Schema types)</li>
...
<li><a href="https://schema.org/Question">schema.org/Question</a> and Answer</li>
...
<ul>
<li>Schema Type <a href="https://schema.org/Answer">schema.org/Answer</a></li>
<li>Schema Type <a href="https://schema.org/Article">schema.org/Article</a>

<ul>
<li>Schema Type <a href="https://schema.org/AdvertiserContentArticle">schema.org/AdvertiserContentArticle</a></li>
<li>Schema Type <a href="https://schema.org/NewsArticle">schema.org/NewsArticle</a>

<ul>
<li>Schema Type <a href="https://schema.org/AnalysisNewsArticle">schema.org/AnalysisNewsArticle</a></li>
<li>Schema Type <a href="https://schema.org/AskPublicNewsArticle">schema.org/AskPublicNewsArticle</a></li>
<li>Schema Type <a href="https://schema.org/BackgroundNewsArticle">schema.org/BackgroundNewsArticle</a></li>
<li>Schema Type <a href="https://schema.org/OpinionNewsArticle">schema.org/OpinionNewsArticle</a></li>
<li>Schema Type <a href="https://schema.org/ReportageNewsArticle">schema.org/ReportageNewsArticle</a></li>
<li>Schema Type <a href="https://schema.org/ReviewNewsArticle">schema.org/ReviewNewsArticle</a></li>
</ul></li>
<li>Schema Type <a href="https://schema.org/SatiricalArticle">schema.org/SatiricalArticle</a></li>
<li>Schema Type <a href="https://schema.org/Report">schema.org/Report</a></li>
<li>Schema Type <a href="https://schema.org/ScholarlyArticle">schema.org/ScholarlyArticle</a>

<ul>
<li>Schema Type <a href="https://schema.org/MedicalScholarlyArticle">schema.org/MedicalScholarlyArticle</a></li>
</ul></li>
<li>Schema Type <a href="https://schema.org/SocialMediaPosting">schema.org/SocialMediaPosting</a>

<ul>
<li>Schema Type <a href="https://schema.org/BlogPosting">schema.org/BlogPosting</a>

<ul>
<li>Schema Type <a href="https://schema.org/LiveBlogPosting">schema.org/LiveBlogPosting</a></li>
</ul></li>
...
<li>Schema Type <a href="https://schema.org/TechArticle">schema.org/TechArticle</a>

<ul>
<li>Schema Type <a href="https://schema.org/APIReference">schema.org/APIReference</a></li>
</ul></li>
</ul></li>
...
<li>Schema Type <a href="https://schema.org/Game">schema.org/Game</a>

<ul>
<li>Schema Type <a href="https://schema.org/VideoGame">schema.org/VideoGame</a></li>
</ul></li>
<li>Schema Type <a href="https://schema.org/HowTo">schema.org/HowTo</a>
...
<li>Schema Type <a href="https://schema.org/MusicPlaylist">schema.org/MusicPlaylist</a>

<ul>
<li>Schema Type <a href="https://schema.org/MusicAlbum">schema.org/MusicAlbum</a></li>
<li>Schema Type <a href="https://schema.org/MusicRelease">schema.org/MusicRelease</a></li>
</ul></li>
...
<li>Schema Type <a href="https://schema.org/CollectionPage">schema.org/CollectionPage</a>

<ul>
<li>Schema Type <a href="https://schema.org/ImageGallery">schema.org/ImageGallery</a></li>
...
<li>Schema Type <a href="https://health-lifesci.schema.org/MedicineSystem">health-lifesci.schema.org/MedicineSystem</a>

<ul>
<li>Schema Type <a href="https://health-lifesci.schema.org/Ayurvedic">health-lifesci.schema.org/Ayurvedic</a></li>
<li>Schema Type <a href="https://health-lifesci.schema.org/Chiropractic">health-lifesci.schema.org/Chiropractic</a></li>
<li>Schema Type <a href="https://health-lifesci.schema.org/Homeopathic">health-lifesci.schema.org/Homeopathic</a></li>
<li>Schema Type <a href="https://health-lifesci.schema.org/Osteopathic">health-lifesci.schema.org/Osteopathic</a></li>
<li>Schema Type <a href="https://health-lifesci.schema.org/TraditionalChinese">health-lifesci.schema.org/TraditionalChinese</a></li>
<li>Schema Type <a href="https://health-lifesci.schema.org/WesternConventional">health-lifesci.schema.org/WesternConventional</a></li>
</ul></li>
</ul></li>
...
<li>Schema Type <a href="https://schema.org/ListItem">schema.org/ListItem</a>

<ul>
<li>Schema Type <a href="https://schema.org/HowToDirection">schema.org/HowToDirection</a></li>
<li>Schema Type <a href="https://schema.org/HowToItem">schema.org/HowToItem</a>

<ul>
<li>Schema Type <a href="https://schema.org/HowToSupply">schema.org/HowToSupply</a></li>
<li>Schema Type <a href="https://schema.org/HowToTool">schema.org/HowToTool</a></li>
</ul></li>
...
<li>Schema Type <a href="https://schema.org/HowToTip">schema.org/HowToTip</a></li>
</ul></li>
<li>Schema Type <a href="https://schema.org/Offer">schema.org/Offer</a>

<ul>
<li>Schema Type <a href="https://schema.org/AggregateOffer">schema.org/AggregateOffer</a></li>
</ul></li>
<li>Schema Type <a href="https://schema.org/Rating">schema.org/Rating</a>

<ul>
<li>Schema Type <a href="https://schema.org/AggregateRating">schema.org/AggregateRating</a></li>
</ul></li>
...
<li>Schema Type <a href="https://schema.org/Trip">schema.org/Trip</a>

<ul>
<li>Schema Type <a href="https://schema.org/BusTrip">schema.org/BusTrip</a></li>
<li>Schema Type <a href="https://schema.org/Flight">schema.org/Flight</a></li>
<li>Schema Type <a href="https://schema.org/TrainTrip">schema.org/TrainTrip</a></li>
<li>Schema Type <a href="https://schema.org/TouristTrip">schema.org/TouristTrip</a></li>
</ul></li>
</ul></li>
</ul></li>
...
<li>Schema Type <a href="https://schema.org/AdministrativeArea">schema.org/AdministrativeArea</a>

<ul>
<li>Schema Type <a href="https://schema.org/City">schema.org/City</a></li>
<li>Schema Type <a href="https://schema.org/Country">schema.org/Country</a></li>
<li>Schema Type <a href="https://schema.org/State">schema.org/State</a></li>
</ul></li>
...
<li>Schema Type <a href="https://schema.org/EventVenue">schema.org/EventVenue</a></li>
...
<li>Schema Type <a href="https://schema.org/HealthAndBeautyBusiness">schema.org/HealthAndBeautyBusiness</a>

<ul>
<li>Schema Type <a href="https://schema.org/BeautySalon">schema.org/BeautySalon</a></li>
<li>Schema Type <a href="https://schema.org/DaySpa">schema.org/DaySpa</a></li>
<li>Schema Type <a href="https://schema.org/HairSalon">schema.org/HairSalon</a></li>
<li>Schema Type <a href="https://schema.org/HealthClub">schema.org/HealthClub</a></li>
<li>Schema Type <a href="https://schema.org/NailSalon">schema.org/NailSalon</a></li>
<li>Schema Type <a href="https://schema.org/TattooParlor">schema.org/TattooParlor</a></li>
</ul></li>
...
<li>Schema Type <a href="https://schema.org/LegalService">schema.org/LegalService</a>

<ul>
<li>Schema Type <a href="https://schema.org/Attorney">schema.org/Attorney</a></li>
<li>Schema Type <a href="https://schema.org/Notary">schema.org/Notary</a></li>
</ul></li>
...
<li>Schema Type <a href="https://chema.org/Hotel">chema.org/Hotel</a></li>
...
<li>Schema Type <a href="https://schema.org/TouristDestination">schema.org/TouristDestination</a></li>
</ul></li>
<li>Schema Type <a href="https://schema.org/Product">schema.org/Product</a>
...
<ul>
<li><p><a href="http://wpsso.com/docs/plugins/wpsso-schema-json-ld/notes/markup-examples/markup-example-for-a-woocommerce-product/">Schema JSON-LD Markup Example for a WooCommerce Product</a>, including its name, description, images, videos, sku, price, condition, availability, ratings, colors, category, width, height, weight, all product variations, and much more.</p></li>
<li><p><a href="http://wpsso.com/docs/plugins/wpsso-schema-json-ld/notes/markup-examples/markup-example-for-a-restaurant/">Schema JSON-LD Markup Example for a Restaurant</a> using the WPSSO PLM add-on to manage the Place / Location information (address, geo coordinates, business hours – daily and seasonal, restaurant menu URL, accepts reservations, etc.).</p></li>
<li><p><a href="http://wpsso.com/docs/plugins/wpsso-schema-json-ld/notes/markup-examples/markup-example-for-a-tech-article/">Schema JSON-LD Markup Example for a Tech Article</a> published on surniaulula.com.</p></li>
</ul>

<h3>WPSSO Core Plugin Required</h3>

<p>WPSSO Schema JSON-LD Markup (aka WPSSO JSON) is an add-on for the <a href="https://wordpress.org/plugins/wpsso/">WPSSO Core plugin</a>.</p>
