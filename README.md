...
<tr><th align="right" valign="top" nowrap>Tags / Keywords</th><td>schema.org, rich results, structured data, knowledge graph, rich pins, rich cards, woocommerce, pinterest, local seo, image seo, video seo, news seo, ld+json, rating, review, recipe, event, product, qapage, howto</td></tr>
</table>
...
<p><em>The <a href="https://wordpress.org/plugins/woocommerce/">WooCommerce plugin by Automattic</a> offers incomplete Schema markup for <a href="https://developers.google.com/search/docs/data-types/product">Google's Product Rich Results</a> requirements.</em></p>
