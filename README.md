...
<blockquote>
<p><strong>Prerequisite:</strong> The WPSSO Schema JSON-LD Markup (WPSSO JSON) plugin is an extension for the <a href="https://wordpress.org/plugins/wpsso/">WordPress Social Sharing Optimization (WPSSO)</a> plugin.</p>
</blockquote>
