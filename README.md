...
<li><p>Includes additional customizable option values in the Social and Search Optimization metabox, displayed or hidden based on the Schema Item Type selected:</p>
