...
<li><p>Includes the Schema JSON-LD created by the Yoast SEO Ho-To and FAQ editor blocks into the main webpage Schema markup (<strong>NEW in v1.31.0</strong>).</p></li>
