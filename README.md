...
<tr><th align="right" valign="top" nowrap>Stable Version</th><td>1.36.1</td></tr>
...
<p>WPSSO Schema JSON-LD Markup is <em>extremely fast</em> and 100% compatible with the new <a href="https://wordpress.org/plugins/gutenberg/">Gutenberg block editor</a> in the upcoming release of WordPress v5.0.</p>
...
<li><p>Provides Schema / Structured Data / SEO JSON-LD markup for the following Schema types (all other Schema types are available in the Pro version):</p>
...
<li><p>Provides Schema / Structured Data / SEO JSON-LD markup for <em>all Schema types and sub-types</em>, including <a href="https://schema.org/ItemList">schema.org/ItemList</a> for Google's mobile carousel feature:</p>
...
<li><p>Moves the Schema JSON-LD created by the Yoast SEO How-To and FAQ editor blocks into the main webpage Schema CreativeWork markup.</p></li>
