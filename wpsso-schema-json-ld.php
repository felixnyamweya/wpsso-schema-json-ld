 ...
 * Description: WPSSO Core add-on to provide Schema JSON-LD / SEO markup for Articles, Events, Local Business, Products, Recipes, Reviews + many more.
 * Requires PHP: 5.4
 * Requires At Least: 3.8
 * Tested Up To: 4.9.5
 * WC Tested Up To: 3.3.4
 * Version: 1.24.6-dev.1
 * 
	...
	class WpssoJson {
		...
		private function min_version_notice() {
			...
			if ( method_exists( 'SucomUtil', 'safe_trigger_error' ) ) {
				...
				$error_prefix = sprintf( __( '%s warning:', 'wpsso-schema-json-ld' ), $info['short'] );
