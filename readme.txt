...
The [WPSSO JSON Pro extension](https://wpsso.com/extend/plugins/wpsso-schema-json-ld/?utm_source=wpssojson-readme-prereq) uses many WPSSO Core Pro plugin features and requires the [WPSSO Core Pro plugin](https://wpsso.com/?utm_source=wpssojson-readme-prereq).
...
<span style="color:#33cc33">&#x0229b;</span> &nbsp; The <a href="https://wpsso.com/extend/plugins/wpsso-schema-json-ld/?utm_source=wpssojson-readme-extends">WPSSO JSON Pro extension</a> uses many WPSSO Core Pro plugin features and requires the <a href="https://wpsso.com/?utm_source=wpssojson-readme-extends">WPSSO Core Pro plugin</a>.
...
(2017/10/15) Fixed the inLanguage property value by calling the SucomUtil get_locale() method instead of the WordPress get_locale() function. Refactored the WpssoJsonShortcodeSchema add / remove shortcode methods.
...
(2017/09/15) Minor code refactoring for WPSSO v3.46.1.
...
(2017/09/03) Added multiple "Event Offers" options in the Social and Search Optimization metabox, including the offer name, price, currency, and availability (Pro version).

= 1.16.2 =

(2017/08/30) Added a tabbed layout to the Schema Markup settings page, moving all definitions of Schema types to a "Schema Types" tab.

= 1.16.1 =

(2017/08/23) Added a 'seller' property to Schema Product type offers (Pro version). Added a 'brand' property to the Schema Product type (Pro version). Added 'Event Start' and 'Event End' options in the Social and Search Optimization metabox (Pro version). 
...
(2017/05/15) Added a new "Additional Type URL" option in the Social and Search Optimization metabox for posts, pages, and custom post types.
...
(2017/03/25) Added a new "Organization" selector in the Social and Search Optimization metabox when the Schema Item Type is an Organization.
