...
**Version 1.15.1-dev.7 (2017/06/29)**
...
(2017/06/29) Renamed the Schema type for the Product itemOffered property from IndividualProduct to ProductModel. Renamed the "hasPart" property for collection / profile / search pages to "mentions" and for blog pages to "blogPost".
