=== Schema JSON-LD Markup | WPSSO Add-on ===
...
(2019/08/27) Moved schema shortcode processing to the new 'wpsso_json_data_graph_element' filter hook in WPSSO Core v6.1.0.
