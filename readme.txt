...
* WPSSO Pro integrates with many 3rd party plugins and services for additional image, video, ecommerce product details, SEO settings, etc. WPSSO JSON Pro includes additional 3rd party integration modules to extended its Schema markup:
	* WP Product Review
...
**Version 1.12.3-dev1 (2017/02/19)**
...
(2017/02/19) Added new options for Reviewed Items (Pro version). Added support for the WP Product Review plugin (Pro version).
