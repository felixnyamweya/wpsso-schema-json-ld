...
**Version 1.24.0-rc.2 (2018/02/23)**
...
(2018/02/23) Refactored the WpssoJson min_version_notice() method to use PHP's trigger_error() and include a notice to refresh plugin update information.
