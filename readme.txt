...
**Version 1.16.7-rc.7 (2017/10/12)**
...
(2017/10/12) Fixed the inLanguage property value by calling the SucomUtil get_locale() method instead of the WordPress get_locale() function. Refactored the WpssoJsonShortcodeSchema add / remove shortcode methods.
