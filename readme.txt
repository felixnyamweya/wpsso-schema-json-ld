...
**Version 1.21.0-rc.2 (2018/02/02)**
...
* *Improvements*
	* None
* *Bugfixes*
	* Fixed a variable name in the WpssoJsonSchema::add_single_comment_data() method.
* *Developer Notes*
	* None
...
(2018/02/02) Added a "SameAs Webpage URLs" option in the Social and Search Optimization metabox.

= 1.20.2 =

(2018/01/27) Moved the headline and publisher custom options in the Social and Search Optimization metabox from Schema Article to Schema CreativeWork.

= 1.20.1 =

(2018/01/25) Fixed a variable name in the WpssoJsonSchema::add_single_comment_data() method.

= 1.20.0 =

(2018/01/14) Added a Course Provider option in the Social and Search Optimization metabox for the Schema Course type. Extended the &#91;schema&#93; shortcode 'prop' attribute to allow adding new array elements.
