...
_x( 'WPSSO extension to add complete Schema JSON-LD / SEO markup (Article, Event, Local Business, Product, Recipe, Review, and much more).', 'plugin description', 'wpsso-schema-json-ld' );
?>
