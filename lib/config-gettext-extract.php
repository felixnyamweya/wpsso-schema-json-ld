...
_x( 'Schema Post Data', 'option label', 'wpsso-schema-json-ld' );
_x( 'Schema Shortcode', 'lib file description', 'wpsso-schema-json-ld' );
_x( 'WPSSO Core extension to add Schema JSON-LD / SEO markup for Articles, Events, Local Business, Products, Recipes, Reviews + many more.', 'plugin description', 'wpsso-schema-json-ld' );
