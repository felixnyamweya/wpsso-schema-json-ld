...
_x( 'Event Organizer Org.', 'option label', 'wpsso-schema-json-ld' );
_x( 'Event Organizer Person', 'option label', 'wpsso-schema-json-ld' );
_x( 'Event Performer Org.', 'option label', 'wpsso-schema-json-ld' );
_x( 'Event Performer Person', 'option label', 'wpsso-schema-json-ld' );
...
_x( 'Claim Summary', 'option label', 'wpsso-schema-json-ld' );
_x( 'Claim Made on Date', 'option label', 'wpsso-schema-json-ld' );
_x( 'Claim First Appearance URL', 'option label', 'wpsso-schema-json-ld' );
